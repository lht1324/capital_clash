                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <span className="ml-2 font-semibold">${investor.investment_amount.toLocaleString()}</span>
                        </div>
                        <div>
                            <span className="text-gray-600">지분율:</span>
                            <span className="ml-2 font-semibold">{(investor.share_percentage * 100).toFixed(2)}%</span>
                        </div>
                        <div>
                            <span className="text-gray-600">영역 색상:</span>
                            <span
                                className="ml-2 inline-block w-6 h-6 rounded border"
                                style={{ backgroundColor: investor.area_color }}
                            ></span>
                        </div>
                        <div>
